package cn.hereyou.backendcommon.config;
...
public class EntityGenerator {
    ...
    private String outputDir = "E:\\java_projects\\backend-parent\\backend-common\\src\\main\\java";
    // 生成类的作者
    private String author = "wuhuipeng";
    // 数据源相关配置
    ...
    // DAO的包路径
    private String daoPackage = "cn.hereyou.backendcommon.dao";
    // 待生成的表名，注意是覆盖更新
